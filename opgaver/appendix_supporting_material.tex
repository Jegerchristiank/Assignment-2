...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{billeder/dcr_morning_model_clean.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth,trim=0 0 0 14,clip]{billeder/textbook_fig9_2_three_loop_model.png}
