...
In Chapter 9 terms, this is a formal/informal balance problem (see the formalisation continuum in the chapter figure) \parencite{guidehealthinformatics2026ch9and27}: complete formalisation is neither realistic nor always desirable. A practical change is lightweight optional contextual events (consultation, reprioritisation, communication intent), designed to improve visibility without imposing heavy documentation burden.
