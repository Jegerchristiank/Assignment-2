...
\textit{Compare Deliverable 1 and Deliverable 2 and produce a delta sheet categorised into missing events, extra events, different order, timing distortions, workarounds/coordination steps, and relabeling/ambiguity.}
...
Table~\ref{tab:d3_delta_sheet} in Appendix~\ref{app:part1_supporting} summarises the full delta comparison between stated and observed routine. Key deltas are:
\begin{itemize}
