...
Overall, the \textit{interview-based DCR} (Deliverable 1) captures \textit{knowledge-as-stated} and \textit{work-as-imagined}, while the observed event sequence (\textit{observed DSR}) captures \textit{knowledge-as-discovered}, \textit{work-as-done}, and \textit{work-as-recorded}. The delta sheet therefore documents a clear and traceable \textit{say-do gap}.
