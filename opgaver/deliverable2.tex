...
Table~\ref{tab:d2_observed_excerpt} provides the observed event-log excerpt with activity references. Relative to the transcript-based baseline (Table~\ref{tab:app_transcript_part1}, lines L02-L12 and L14-L18), the key comparison anchors are E03 (extra coordination), E09 (order shift), and E10 (workaround).
